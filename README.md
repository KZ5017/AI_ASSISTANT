...
- 2026-09-02 UI finomítás: a fő asszisztens-kódblokk külső kerete `--radius-lg` (12px). Sötét témában az inputok az alap `--color-surface` hátteret öröklik, a kódblokk mindkét módban `--color-surface-soft`, a beszélgetésmenü pedig `--color-page` hátterű; a sötét page/surface/text tokenek `#11161e` / `#1d222a` / `#cbd5e7`.
