...
Az Excel prompt policy legyen szigoru, rovid, index-router alapu es olvasasi/informaciokinyeresi iranyu. A jelenlegi elfogadott valtozat szandekosan 9B-barátabb: kevesebb ismetles, egyertelmu fajlnev-utalas flow, celzott read-only toolvalasztas.
