...
20. `020_sensitive_request_and_output_guard_plan.md` - Implementalva: determinisztikus backend bemeneti es kimeneti biztonsagi kapuk az Assistant sajat belso utasitasainak, futasideju kepessegeinek es konfiguracios titkainak vedelmere, legitim muszaki tudastartalom blokkolasa nelkul.
